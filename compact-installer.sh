...
if [ -n "${INSTALLER_DOWNLOAD_URL:-}" ]; then
    ...
    ARTIFACT_DOWNLOAD_URL="${INSTALLER_BASE_URL}/midnightntwrk/compact/releases/download/compact-v0.2.0"
fi
...
{"binaries":["CARGO_DIST_BINS"],"binary_aliases":{},"cdylibs":["CARGO_DIST_DYLIBS"],"cstaticlibs":["CARGO_DIST_STATICLIBS"],"install_layout":"unspecified","install_prefix":"AXO_INSTALL_PREFIX","modify_path":true,"provider":{"source":"cargo-dist","version":"0.28.6"},"source":{"app_name":"compact","name":"compact","owner":"midnightntwrk","release_type":"github"},"version":"0.2.0"}
EORECEIPT
...
The installer for compact 0.2.0

This script detects what platform you're on and fetches an appropriate archive from
https://github.com/midnightntwrk/compact/releases/download/compact-v0.2.0
...
download_binary_and_run_installer() {
    ...
    case "$_artifact_name" in 
        "compact-aarch64-apple-darwin.tar.xz")
            ...
            _checksum_value="365088b8bcecdd365428878bbcd8bc97f7c1970c092e8d3ceab3f9373c35df90"
            _bins="compact"
        ...
        "compact-x86_64-apple-darwin.tar.xz")
            ...
            _zip_ext=".tar.xz"
            _checksum_style="sha256"
            _checksum_value="8869dca4cc5ecc600de9cfb74aad71b39a283bc92db86e04bfcd3488c86e8b2e"
            _bins="compact"
            _bins_js_array='"compact"'
            _libs=""
            _libs_js_array=""
        ...
        "compact-x86_64-unknown-linux-musl.tar.xz")
            ...
            _zip_ext=".tar.xz"
            _checksum_style="sha256"
            _checksum_value="d8390eaf14bbd6906edae21be630116aab2c18e60ad0374b921cf57edec1d266"
            _bins="compact"
            _bins_js_array='"compact"'
            _libs=""
            _libs_js_array=""
